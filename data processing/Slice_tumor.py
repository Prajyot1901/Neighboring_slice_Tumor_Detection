...
image_dir = r".\Tumor_FLAIR" # Update this path to your FLAIR/T1/T2 images directory and run the code to generate the tumor slices.
mask_dir = r".\Segmentation_masks" # Update this path to your segmentation masks directory.
output_dir = r".\FLAIR\Tumor" # Update this path to your desired output directory for tumor slices. The code will save the tumor slices in this directory.
...
for img_name in os.listdir(image_dir):
    ...
    mask2 = (mask == 2).astype(np.uint8)
    mask = ((mask == 1) | (mask == 4)).astype(np.uint8)
    ...
    slices_to_save = set()
    slices_to_save.update([top_slice - 3, top_slice - 2, top_slice - 1, bottom_slice + 3, bottom_slice + 2, bottom_slice + 1])
